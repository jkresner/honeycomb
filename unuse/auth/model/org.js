...
//   groupChatId:            { type: ObjectId, ref: 'Chat' },
  status:                 { type: String, enum: Enum.AUTH.TEAM.STATUS },
  ...
  members: [{
    ...
    scopes:               [{ type: String, enum: Enum.AUTH.TEAM.SCOPES }],     // essentially roles and permissions
    status:               { type: String, enum: Enum.AUTH.TEAM.STATUS }
  }],
  log:                    Log  // Log of notable actions team members have taken over time
}
...
//   connection:               {},
  ...
  cohort: {
    ...
    category:               { type: String, enum: Enum.AUTH.ORG.TYPE },
    staff:                  { type: String, enum: Enum.AUTH.HEADCOUNT },
    developers:             { type: String, enum: Enum.AUTH.HEADCOUNT }
  },
  teams:                    [TeamSchema]
}
