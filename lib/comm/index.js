...
module.exports = function(cfg) {
  ...
  if ((cfg.comm||{}).transports.indexOf('ses') > -1 && (cfg.wrappers||{}).ses) // honey.cfg('wrappers.ses'))
    comm.transports.ses = require('./ses')(cfg)

  if ((cfg.comm||{}).transports.indexOf('smtp') > -1 && (cfg.wrappers||{}).smtp) // honey.cfg('wrappers.smtp'))
    comm.transports.smtp = require('./smtp')(cfg)
