...
var defaults = {
  ...
  log: {
    ...
    it: {
      ...
      mw:                    { init:u,trace:u,api:u,apiJson:u,forward:u,valid:u,page:u,notFound:r,error:r,forbid:u,authRedirect:u,oauth:u,logout:u,cached:u,param:u,recast:u,project:u,wrap:u,slow:u,orient:u,remember:u },
...
module.exports = () => {
  ...
  cfg.log.verbose = process.env.LOG_VERBOSE || cfg.log.verbose
  cfg.log.quiet = process.env.LOG_QUIET || cfg.log.quiet
