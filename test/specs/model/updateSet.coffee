...
basic = ->
  ...
  IT "can update a property", ->
    ...
    DB.ensureDoc 'Tag', FIXTURE.tags.testupdateset, ->
      Tag.getById FIXTURE.tags.testupdateset._id, (e0, t0) ->
        expect(t0.slug).to.equal('test-update-set')
        Tag.updateSet t0._id, {slug:"#{t0.slug}-#{suffix}"}, (e1, t1) ->
          expect(t1.slug).to.equal("test-update-set-#{suffix}")
          Tag.getById FIXTURE.tags.testupdateset._id, (e2, t2) ->
  ...
  IT "adds new _id of sub-schema in array", ->
    ...
    Org.create t, (e1, r1) ->
      ...
      Org.updateSet r1._id, {teams}, (e2, r2) ->
